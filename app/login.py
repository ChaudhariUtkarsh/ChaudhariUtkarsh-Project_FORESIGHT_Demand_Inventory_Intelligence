...
if st.session_state.logged_in:
    st.markdown("---")
    st.success(f"""Logged in Successfully User : {st.session_state.username} Role : {st.session_state.role}""")
    ...
    if st.button("Open Dashboard"):
        try:
            ...
            st.warning("""Unable to redirect automatically. Open Dashboard manually from Streamlit sidebar.""")
