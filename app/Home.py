...
st.markdown("---")
st.write("""Project FORESIGHT helps businesses forecast future demand, identify inventory risks, reduce stockouts, minimise overstock, and improve supply chain decisions using Machine Learning.""")
